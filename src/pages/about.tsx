          ...
          >
            <motion.div variants={item} className="mb-12">
              ...
              <p className="text-lg text-gray-600 mb-6">
                Founded in 2010, Kavita Cool Home has been providing reliable and affordable
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Our team of dedicated professionals is here to provide you with the best service
              possible.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                bio: 'With over 15 years of experience in appliance repair, Rajesh leads our team with expertise and dedication.'
              },
              {
                name: 'Priya Sharma',
                role: 'Service Manager',
                image: '/images/team/priya.jpg',
                bio: 'Priya ensures every customer receives exceptional service and support throughout their repair journey.'
              },
              {
                name: 'Amit Patel',
                role: 'Lead Technician',
                image: '/images/team/amit.jpg',
                bio: 'Amit specializes in complex repairs and is certified in multiple appliance brands.'
              }
            ].map((member, index) => (
              <motion.div
                key={member.name}
                ...
                <div className="w-32 h-32 mx-auto mb-4 rounded-full bg-gray-200 overflow-hidden">
                  <img
                    ...
                    onError={(e) => {
                      ...
                      target.src = 'https://source.unsplash.com/random/300x300/?portrait';
                    }}
                  />
                </div>
